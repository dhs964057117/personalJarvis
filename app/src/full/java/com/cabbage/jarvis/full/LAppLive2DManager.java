...
import static com.cabbage.jarvis.live2d.LAppDefine.*;
...
public class LAppLive2DManager {
    ...
    public void changeScene(int index) {
         ...
         * 提出进行模型半透明显示的样品。
         * 此处为USE_RENDER_TARGET、USE_MODEL_RENDER_如果定义了TARGET
         * 在另一渲染目标上绘制模型，并将绘制结果作为纹理粘贴到另一精灵上。
         */
