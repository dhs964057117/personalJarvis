...
object BaiduLocation {
     ...
     * 初始化定位参数配置
     */
    private fun initLocationOption(): LocationClient {
//定位服务的客户端。宿主程序在客户端声明此类，并调用，目前只支持在主线程中启动
        val locationClient = LocationClient(App.application)
...
//        locationClient.registerLocationListener(myLocationListener)
    ...
    fun startLoc(myLocationListener: MyLocationListener){
        //开始定位
        //注册监听函数
     ...
     * 实现定位回调
     */
    open class MyLocationListener : BDAbstractLocationListener() {
